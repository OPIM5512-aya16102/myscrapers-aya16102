...
![LinkedIn](https://img.shields.io/badge/Jupyter-Notebook-orange.svg)
...
You can interactively explore how the models perform, compare error metrics, and see exactly which features (like Age, Mileage, or Make) drive the price of a car using the interactive interactive UI.
